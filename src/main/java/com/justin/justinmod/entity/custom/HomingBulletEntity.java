...
public class HomingBulletEntity extends ProjectileEntity {
    ...
    public HomingBulletEntity(EntityType<? extends ProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.noClip = true;
    }

    public HomingBulletEntity(World world, LivingEntity owner, Entity target, Direction.Axis axis) {
        this(ModEntities.HOMING_BULLET, world);
        this.setOwner(owner);
